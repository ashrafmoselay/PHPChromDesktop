    ...
    public function update(Request $request, Category $category)
    {
        ...
        if (!is_null($category->percentage)) {
            ...
            foreach ($products as $prod) {
                $supplier_dicount_percent = $prod->category->supplier_dicount_percent;
                ...
                foreach ($units as $u) {
                    ...
                    if ($supplier_dicount_percent) {
                        $priceafterdiscount = $cost - ($cost * $supplier_dicount_percent / 100);
                        $cost = round($priceafterdiscount, 2);
                    }
