                        ...
                        <div class="box-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                    <tr
                                        class="{{ $totalS > $employee->target || $percent >= 100 ? 'bg-green' : 'bg-danger' }}">
                                        <td>{{ $totalS }}</td>
                                ...
                                <thead>
                                    @if (auth()->user()->employee_id)
                                        <tr>
                                            ...
                                            <td class="hideprint hide">إجمالى الربح</td>
                                            <td class="hide">@lang('front.percentage')</td>
                                ...
                                <tbody>
                                    ...
                                    @if (auth()->user()->employee_id)
                                        <tr>
                                            ...
                                            <td class="hideprint hide">{{ $allorder }}</td>
                                            <td class="hide">{{ $employee->percent }} %</td>
                                    ...
                                    @else
                                        <tr>
                                            ...
                                            @else
                                                ...
                                                @endif
                                                <td class="hideprint">
                                                    {{ currency($orderPercent, 'EGP', 'EGP', $format = true) }}
                                                </td>
                                                <td>{{ currency($totalReturns, 'EGP', 'EGP', $format = true) }}</td>
                                            @endif
