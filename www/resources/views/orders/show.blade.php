                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                        @if($settings['logo'])
                                            <div class="pull-left">
                                                <img style="width: 155px;" src="{{ env('APP_URL') }}{{\Illuminate\Support\Facades\Storage::url($settings['logo'])}}">
                                            </div>
                                        @endif
                                        <div class="pull-left">
                                            <h4>
                    ...
                    <div  class="col-md-12 text-center">
                        <h3>
                            ...
                            @php
                                $colspan = 5;
                            @endphp
                            <table style="max-width: 290mm!important;" class="table table-bordered">
                                        <thead>
                                        <tr>
                                            <td>#</td>
                                        ...
                                        @foreach($order->details as $item)
                                            ...
                                            <tr>
                                                <td>
                                                    {{$loop->iteration}}
                                                    <img style="width: 20px;" class="stateIcon" src="{{ $item->pivot->status?asset('icons/yes.png'):asset('icons/no.png') }}" />
                                                </td>
                                                <td>
                                                    {{$item->full_name}}
                                                </td>
